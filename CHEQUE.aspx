...
<body style="background-color:gainsboro">
    ...
    <section class="container-fluid" style="width:50%;background-color:darkcyan;border-style:groove;border-radius:30px">
       <div class="row">
           <div class="col-lg-12">
               <h1 class="text-center w3-animate-fading w3-anmate-right" style="background-color:royalblue;opacity:8;font-family:'Buxton Sketch';font-size:xx-large;font-weight:bolder;color:white;border-style:groove;border-radius:30px"><strong><u style="text-underline-position:below">CHEQUE DETAILS</u></strong></h1>
              ...
              <asp:TextBox ID="TextDOCUMENTNO" CssClass="form-control" TextMode="Number" placeholder="xxxxx"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server"></asp:TextBox>
               </div>
              <div class="form-group">
              ...
              <asp:TextBox ID="TextDate" CssClass="form-control" TextMode="Date" placeholder="xxxxx"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server"></asp:TextBox>
              </div>
              <div class="form-group">
               <asp:Label ID="Label3" runat="server" Text="BANK NAME:" style="font-family:Arial;font-weight:bolder"></asp:Label>
                  <asp:DropDownList ID="DropDownList1" CssClass="form-control"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server" DataSourceID="SqlDataSource1" DataTextField="BankName" DataValueField="BankName" ></asp:DropDownList>
                  ...
                  <div class="clearfix">
                  <center><asp:Button ID="Btn_OK" style="border-style:groove;border-radius:10px" runat="server" Text="OK" OnClick="Btn_OK_Click" /></center>
