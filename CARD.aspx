...
<body style="background-color:gainsboro">
    ...
    <section class="container-fluid" style="width:50%;background-color:darkcyan;border-style:groove;border-radius:30px">
      <div class="row">
          <div class="col-lg-12">
              <h1 class="text-center w3-animate-fading w3-anmate-right" style="background-color:royalblue;opacity:8;font-family:'Buxton Sketch';font-size:xx-large;font-weight:bolder;color:black;border-style:groove;border-radius:30px"><strong><u style="text-underline-position:below">CARD DETAILS</u></strong></h1>
              <hr  style="margin-top:-1%;color:lightgray;border:solid 5px;"/>
              ...
              <asp:TextBox ID="TextCARDNO" CssClass="form-control" TextMode="Number" placeholder="xxxxx"  style="width:25%;margin-top:-4%;margin-left:17%;border-style:groove;border-radius:30px" runat="server"></asp:TextBox>
                  <asp:TextBox ID="TextDATE"  CssClass="form-control" style="width:25%;margin-top:-5%;margin-left:43%;border-style:groove;border-radius:30px" TextMode="Date" runat="server"></asp:TextBox>
               </div>
              <div class="form-group">
              ...
              <asp:TextBox ID="TextHOLDERNAME" CssClass="form-control" placeholder="xxxxx"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server"></asp:TextBox>
              </div>
              <div class="form-group">
               <asp:Label ID="Label3" runat="server" Text="ISSUEINGBANK:" style="font-family:Arial;font-weight:bolder"></asp:Label>
                  <asp:DropDownList ID="DropDownList1" CssClass="form-control"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server" DataSourceID="SqlDataSource2" DataTextField="BankName" DataValueField="BankName" ></asp:DropDownList>
              ...
              <div class="form-group">
               <asp:Label ID="Label4" runat="server" Text="APPROVALNO:" style="font-family:Arial;font-weight:bolder"></asp:Label>
                  ...
                  <asp:TextBox ID="TextAPPROVALNO" CssClass="form-control" TextMode="Number" placeholder="xxxxx"  style="width:51.7%;margin-left:17%;margin-top:-4%;border-style:groove;border-radius:30px" runat="server"></asp:TextBox>
              </div>
                   <hr style="margin-top:2%;color:lightgray;border:solid 5px;"/>
                  <div class="clearfix">
                  <center><asp:Button ID="Btn_OK" runat="server" style="border-style:groove;border-radius:10px" Text="OK" OnClick="Btn_OK_Click" /></center>
